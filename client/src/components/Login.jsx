                ...
                <div className="flex w-full flex-col items-center justify-center px-6 py-10 md:w-1/2 md:px-10">
                    <form onSubmit={onSubmitHandler} className="flex w-full max-w-sm flex-col items-center justify-center">
                        ...
                        {!isResetPassword && (
                            <>
                                {/* Google button  */}
                                <button type="button" className="mt-8 flex h-12 w-full items-center justify-center rounded-full bg-gray-500/10 dark:bg-gray-700">
                        ...
                        {isSignUp && (
                            <div className="mb-6 flex h-12 w-full items-center gap-2 overflow-hidden rounded-full border border-gray-300/60 bg-transparent pl-6 dark:border-gray-700">
                                ...
                                <input type="text" placeholder="Full name" className="h-full w-full bg-transparent text-sm text-gray-500/80 outline-none placeholder-gray-500/80 dark:text-gray-200 dark:placeholder-gray-400" required />
                            </div>
                        )}
                        ...
                        <div className="flex h-12 w-full items-center gap-2 overflow-hidden rounded-full border border-gray-300/60 bg-transparent pl-6 dark:border-gray-700">
                            ...
                            <input type="email" placeholder="Email id" className="h-full w-full bg-transparent text-sm text-gray-500/80 outline-none placeholder-gray-500/80 dark:text-gray-200 dark:placeholder-gray-400" required />
                        </div>
                        ...
                        {!isResetPassword && (
                            <>
                                ...
                                <div className="mt-6 flex h-12 w-full items-center gap-2 overflow-hidden rounded-full border border-gray-300/60 bg-transparent px-6 dark:border-gray-700">
                                    ...
                                    <input type={showPassword ? 'text' : 'password'} placeholder="Password" className="h-full w-full bg-transparent text-sm text-gray-500/80 outline-none placeholder-gray-500/80 dark:text-gray-200 dark:placeholder-gray-400" required />
                                ...
                                <div className="mt-8 flex w-full items-center justify-between text-gray-500/80 dark:text-gray-400">
