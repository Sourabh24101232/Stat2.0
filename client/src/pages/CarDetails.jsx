    ...
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
        ...
        <div className="lg:col-span-2">
          ...
          <p className="mb-6 text-gray-500 dark:text-gray-400">{car.category} • {car.year}</p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div key={index} className="flex flex-col items-center rounded-lg bg-light p-4 dark:bg-gray-800">
        ...
        <div className="self-start">
          ...
          <form onSubmit={handleBooking} className="h-max space-y-6 rounded-xl bg-white p-6 text-gray-500 shadow-lg dark:border dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:shadow-[0px_10px_25px_rgba(0,0,0,0.35)]">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input value={pickupDate} onChange={(e) => setPickupDate(e.target.value)} type="date" id="pickup-date" className="rounded-lg border border-borderColor bg-transparent px-3 py-2 text-gray-700 outline-none dark:border-gray-700 dark:text-gray-200" required min={today} />
            </div>

            <div className="flex flex-col gap-2">
              <label htmlFor="return-date">Return Date</label>
              <input value={returnDate} onChange={(e) => setReturnDate(e.target.value)} type="date" id="return-date" className="rounded-lg border border-borderColor bg-transparent px-3 py-2 text-gray-700 outline-none dark:border-gray-700 dark:text-gray-200" required min={pickupDate || today} />
            </div>
