        ...
        <table className="w-full border-collapse text-left text-sm text-gray-600 dark:text-gray-300">
          ...
          <tbody>
            ...
            {bookings.map((booking) => (
              <tr
                key={booking._id}
                className="border-t border-borderColor text-gray-500 dark:border-gray-700 dark:text-gray-400"
              >
                <td className="p-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="max-md:hidden">
                      ...
                      {booking.pickupLocation && (
                        <a
                          href={`https://www.google.com/maps?q=${booking.pickupLocation.latitude},${booking.pickupLocation.longitude}`}
                          target="_blank"
                          rel="noreferrer"
                ...
                <td className="p-3">
                  ...
                  booking.status === "confirmed" ? (
                    <select
                      ...
                      onChange={(event) =>
                        changeBookingStatus(booking._id, event.target.value)
                      }
                    ...
                    <span
                      className={`rounded-full px-3 py-1 text-xs font-semibold ${booking.status === "confirmed" ? "bg-green-100 text-green-500 dark:bg-green-400/15" : "bg-red-100 text-red-500 dark:bg-red-400/15"}`}
                    >
                      {" "}
                      {booking.status}
                    </span>
