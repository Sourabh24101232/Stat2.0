...
export const addCar = async (req, res) => {
  try {
    ...
    const whatsappNumber = String(car.whatsappNumber || "").replace(/\D/g, "");
    ...
    await User.findByIdAndUpdate(id, { whatsappNumber });
